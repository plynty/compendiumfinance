...
Below is an illustration that shows how fees erode your investment success over time.  The example below was generated from our [fee calculator](fee-calc.html). After we review how the calculator works, you may want to use it to see how your current fees could be affecting your future.
...
So that’s all you need to know in order to use the [fee calculator](fee-calc.html) to see how fees affect you over time.
...
To see the effect of fees on your own accounts, go to the [fee calculator](fee-calc.html) and enter your information.
